                            ...
                            <v-col>
                                <v-card max-width="1200" class="mx-auto" flat dark color="transparent">
                                    <v-row class="fill-height flex-column pa-5" align="center" justify="center">
                                        ...
                                        <div class="display-3 my-5 font-weight-black"><span class="main-title">寻找顾问Meet Consultants</span>
                                        </div>
                    ...
                    <v-card max-width="1200" class="mx-auto pa-5" color="" light>
                        <v-data-iterator :items="allConsultants" :search="search" :sort-by="sortBy.toLowerCase()"
                            ...
                            <template v-slot:default="props">
                                <v-row>
                                    <v-col class="py-12" v-for="item in allConsultants" :key="item.id" cols="6" md="3">
                                        <v-item-group>
                                            <v-item v-slot:default="{ active, toggle }">
                                                <v-hover v-slot:default="{ hover }">
                                                    <v-card height="310" width="300" class="text-center"
                                                        ...
                                                        <v-btn class="float-right mr-2 mb-2" icon color="blue-grey">
                                                            <v-icon>
                                                                fas fa-envelope
                                                            </v-icon>
                                                        </v-btn>
                                                        <v-dialog v-model="dialog" full-width>
                                                            <template v-slot:activator="{ on }">
                                                                <v-btn color="blue" dark icon v-on="on"
                                                                    ...
                                                                    <v-col>
                                                                        <v-card>
                                                                            ...
                                                                            <v-card-title class="white--text pa-0"
                                                                                style="background-color:#232332;height: 300px;">
                                                                                    ...
                                                                                    <v-col class="pa-0" align="start">
                                                                                        <v-card width="1200px"
                                                                                            ...
                                                                                            <div style="width: 100%;height: 100%;" class="d-flex">
                                                                                                <img  src="../../assets/avatar.jpg" style="height: 300px" alt="">
                                                                                                <div class="mx-5">
                                                                                                    <h1 class="display-1 pa-2">{{consultant.name}}</h1>
                                                                                                    <h2 class="title pa-2" >{{consultant.position}}</h2>
                                                                                                    <div class="subtitle-2 pa-2"><i class="fas fa-map-marker-alt mr-2"></i>{{consultant.location}}</div>
                                                                                                    <div class="subtitle-2 pa-2"><i class="far fa-envelope  mr-2" ></i>{{consultant.email}}</div>
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        <v-btn style="position: absolute;right:5px;top:5px" color="white darken-1" icon
                                                                                        @click="dialog = false">
