                                                        ...
                                                        <v-col cols="12" md="6">
                                                            <v-card class="pa-10" width="700" dark color="transparent" flat>
                                                                <v-card-text>
                                                                    ...
                                                                    <div class="title py-5 font-weight-bold">薪酬组织发展</div>
                                                                    <p>为企业提供人才战略咨询、组织领导力发展，企业大学及管培生项目搭建，薪酬绩效体系设计，胜任力模型搭建等 
                                                                    </p>
                                                                    <div class="title py-5 font-weight-bold">专业招聘服务</div>
                                                                    <p>RPO、批量招聘、蓝灰领、零时工及专场招聘会 
                                                                    </p>
                                                                </v-card-text>
                                                            </v-card>
                                                        </v-col>
