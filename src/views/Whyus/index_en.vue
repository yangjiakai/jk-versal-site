                                            ...
                                            <v-col cols="12" md="6">
                                                <v-card class="pa-10" width="700" dark color="transparent" flat>
                                                    <v-card-text>
                                                        ...
                                                        <p>目前上海、西安团队40人规模，聚焦江浙沪地区以及北京、西北地区互联网行业招聘，成功服务于一二线大厂、明星独角兽公司、传统企业的互联网创新板块，我们实行职能专注，我们有技术招聘组（高P类及以上Java、前端、移动端等）、产品运营招聘组（高P类及以上C端产品、B端产品、平台运营等）、商务营销组（高P类及以上客户总监、营销总监等
                                                        </p>
